...
print(count_words_frequency("the cat sat on the mat the cat"))



print("Exercise 3 — Inventory System=========================================")
...
print(add_stock(inventory, "mango", 10))      # mango should be 30
print(add_stock(inventory, "grape", 25))      # grape should be added
print(sell_item(inventory, "apple", 20))      # apple should be 30
print(sell_item(inventory, "banana", 50))     # "Not enough stock"
print(sell_item(inventory, "papaya", 10))     # "Item not found"
print(get_low_stock(inventory, 30))           # items with stock below 30